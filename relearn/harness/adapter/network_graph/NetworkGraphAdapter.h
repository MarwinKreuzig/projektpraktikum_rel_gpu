...
public:
    ...
    [[nodiscard]] static NetworkGraph::DistantEdges get_all_in_edges(const NetworkGraph& ng, const MPIRank my_rank, const NeuronID neuron_id, const SignalType signal_type) {
        const auto& all_distant_edges = ng.get_distant_in_edges(neuron_id);
        const auto& all_local_edges = ng.get_local_in_edges(neuron_id);

        NetworkGraph::DistantEdges filtered_edges{};
    ...
    [[nodiscard]] static NetworkGraph::DistantEdges get_all_out_edges(const NetworkGraph& ng, const MPIRank my_rank, const NeuronID neuron_id, const SignalType signal_type) {
        const auto& all_distant_edges = ng.get_distant_out_edges(neuron_id);
        const auto& all_local_edges = ng.get_local_out_edges(neuron_id);
    ...
    [[nodiscard]] static NetworkGraph::DistantEdges get_all_in_edges(const NetworkGraph& ng, const MPIRank my_rank, const NeuronID neuron_id) {
        const auto& all_distant_edges = ng.get_distant_in_edges(neuron_id);
        const auto& all_local_edges = ng.get_local_in_edges(neuron_id);
    ...
    [[nodiscard]] static NetworkGraph::DistantEdges get_all_out_edges(const NetworkGraph& ng, const MPIRank my_rank, const NeuronID neuron_id) {
        const auto& all_distant_edges = ng.get_distant_out_edges(neuron_id);
        const auto& all_local_edges = ng.get_local_out_edges(neuron_id);

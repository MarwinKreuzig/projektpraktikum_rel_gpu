...
void init_neuron_model(RelearnTypes::number_neurons_type number_neurons) CUDA_DEFINITION

void init_neurons(const RelearnTypes::number_neurons_type start_id, const RelearnTypes::number_neurons_type end_id)  CUDA_DEFINITION
void update_activity(const size_t step, const double* syn_input, const double* stimulation)  CUDA_DEFINITION


void create_neurons(const RelearnTypes::number_neurons_type creation_count)  CUDA_DEFINITION

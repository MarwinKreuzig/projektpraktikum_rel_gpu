...
#pragma warning(disable : 4624) // destructor was implicitly defined as deleted
        ...
        using is_public_base_of = std::is_convertible<U*, T*>;
        ...
        struct ipb_non_final {
            ...
            struct fn : U {
                ...
                template <class X>
                static auto g(X x) -> decltype(f(x));
        ...
        template <class T, class U>
        struct can_cast<T, U, decltype((void)(U*)(T*)0)> : std::true_type { };

        template <class T, class U>
        using is_virtual_base_of = std::integral_constant<bool, can_cast<U, T>::value && !can_cast<T, U>::value>;

        // compute_base_modifiers
        template <class C, class B>
        constexpr unsigned compute_base_modifiers() noexcept {

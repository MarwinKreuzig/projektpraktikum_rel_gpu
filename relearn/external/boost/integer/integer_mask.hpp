...
#if ((defined(ULLONG_MAX) && (ULLONG_MAX > ULONG_MAX)) || (defined(ULONG_LONG_MAX) && (ULONG_LONG_MAX > ULONG_MAX)) || (defined(ULONGLONG_MAX) && (ULONGLONG_MAX > ULONG_MAX)) || (defined(_ULLONG_MAX) && (_ULLONG_MAX > ULONG_MAX)))

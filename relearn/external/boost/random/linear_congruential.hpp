...
namespace random {
    ...
    public:
         ...
         */
        BOOST_RANDOM_DETAIL_SEED_SEQ_SEED(linear_congruential_engine, SeedSeq, seq) { seed(detail::seed_one_int<IntType, m>(seq)); }
         ...
         */
        template <class It>
        void seed(It& first, It last) { seed(detail::get_one_int<IntType, m>(first, last)); }
        ...
        friend bool operator==(const linear_congruential_engine& x,
            const linear_congruential_engine& y) { return x._x == y._x; }
        friend bool operator!=(const linear_congruential_engine& x,
            const linear_congruential_engine& y) { return !(x == y); }
    ...
    public:
         ...
         */
        template <class It>
        void seed(It& first, It last) { lcf.seed(first, last); }
        /**
         * Seeds the generator with values produced by @c seq.generate().
         */

...
namespace random {
    ...
    public:
        ...
        public:
            ...
            BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(param_type, lhs, rhs) { return lhs._k == rhs._k && lhs._lambda == rhs._lambda; }
         ...
         * Requires: k > 0 && lambda > 0
         */
        explicit non_central_chi_squared_distribution(RealType k_arg = RealType(1), RealType lambda_arg = RealType(1))
        ...
        RealType operator()(URNG& eng, const param_type& parm) const { return non_central_chi_squared_distribution(parm)(eng); }
        ...
        BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(non_central_chi_squared_distribution, lhs, rhs) { return lhs.param() == rhs.param(); }

...
namespace random {
    ...
    public:
        ...
        public:
            ...
            BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(param_type, lhs, rhs) { return lhs._min == rhs._min && lhs._max == rhs._max; }
        ...
        result_type operator()(Engine& eng) const { return detail::generate_uniform_real(eng, _min, _max); }
         ...
         */
        template <class Engine>
        result_type operator()(Engine& eng, const param_type& parm) const { return detail::generate_uniform_real(eng, parm.a(), parm.b()); }
         ...
         */
        BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(uniform_real_distribution, lhs, rhs) { return lhs._min == rhs._min && lhs._max == rhs._max; }

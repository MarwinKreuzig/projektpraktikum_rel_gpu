...
namespace random {
    ...
    public:
        ...
        public:
            ...
            BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(param_type, lhs, rhs) { return lhs._mean == rhs._mean && lhs._beta == rhs._beta; }
        ...
        RealType min BOOST_PREVENT_MACRO_SUBSTITUTION() const { return RealType(-std::numeric_limits<RealType>::infinity()); }
        /** Returns the largest value that the distribution can produce. */
        RealType max BOOST_PREVENT_MACRO_SUBSTITUTION() const { return RealType(std::numeric_limits<RealType>::infinity()); }
         ...
         */
        BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(laplace_distribution, lhs, rhs) { return lhs._mean == rhs._mean && lhs._beta == rhs._beta; }

...
namespace random {
    ...
    public:
         ...
         */
        template <class It>
        inversive_congruential_engine(It& first, It last) { seed(first, last); }
         ...
         */
        BOOST_RANDOM_DETAIL_SEED_SEQ_SEED(inversive_congruential_engine, SeedSeq, seq) { seed(detail::seed_one_int<IntType, modulus>(seq)); }
         ...
         */
        template <class It>
        void seed(It& first, It last) { seed(detail::get_one_int<IntType, modulus>(first, last)); }

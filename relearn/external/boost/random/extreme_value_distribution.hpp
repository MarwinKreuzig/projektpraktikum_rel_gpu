...
namespace random {
    ...
    public:
        ...
        public:
            ...
            BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(param_type, lhs, rhs) { return lhs._a == rhs._a && lhs._b == rhs._b; }
         ...
         */
        BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(extreme_value_distribution, lhs, rhs) { return lhs._a == rhs._a && lhs._b == rhs._b; }

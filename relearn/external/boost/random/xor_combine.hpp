...
namespace random {
    ...
    public:
        ...
        static BOOST_CONSTEXPR result_type min BOOST_PREVENT_MACRO_SUBSTITUTION() { return (URNG1::min)() < (URNG2::min)() ? (URNG1::min)() : (URNG2::min)(); }
        /** Returns the largest value that the generator can produce. */
        static BOOST_CONSTEXPR result_type max BOOST_PREVENT_MACRO_SUBSTITUTION() { return (URNG1::max)() > (URNG2::max)() ? (URNG1::max)() : (URNG2::max)(); }
        ...
        BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(xor_combine_engine, x, y) { return x._rng1 == y._rng1 && x._rng2 == y._rng2; }

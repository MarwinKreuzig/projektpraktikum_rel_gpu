...
namespace random {
    ...
    public:
         ...
         */
        template <class It>
        subtract_with_carry_engine(It& first, It last) { seed(first, last); }
        ...
        static BOOST_CONSTEXPR result_type max BOOST_PREVENT_MACRO_SUBSTITUTION() { return boost::low_bits_mask_t<w>::sig_bits; }
        ...
        template <class It>
        void generate(It first, It last) { detail::generate_from_int(*this, first, last); }
    ...
    public:
        ...
        /** Fills a range with random values. */
        template <class Iter>
        void generate(Iter first, Iter last) { detail::generate_from_real(*this, first, last); }
    ...
    class subtract_with_carry : public subtract_with_carry_engine<IntType,

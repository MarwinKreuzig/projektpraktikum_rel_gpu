...
namespace random {
    ...
    public:
        ...
        public:
            ...
            BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(param_type, lhs, rhs) { return lhs._m == rhs._m && lhs._n == rhs._n; }
         ...
         */
        BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(fisher_f_distribution, lhs, rhs) { return lhs._impl_m == rhs._impl_m && lhs._impl_n == rhs._impl_n; }

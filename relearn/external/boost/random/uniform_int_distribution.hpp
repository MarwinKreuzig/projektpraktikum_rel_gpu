...
#pragma warning(pop)
    ...
    public:
        ...
        result_type operator()(Engine& eng) const { return detail::generate_uniform_int(eng, _min, _max); }
         ...
         */
        template <class Engine>
        result_type operator()(Engine& eng, const param_type& parm) const { return detail::generate_uniform_int(eng, parm.a(), parm.b()); }
         ...
         */
        BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(uniform_int_distribution, lhs, rhs) { return lhs._min == rhs._min && lhs._max == rhs._max; }

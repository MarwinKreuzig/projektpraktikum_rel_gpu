...
namespace random {
    ...
    public:
        ...
        template <class It>
        mersenne_twister_engine(It& first, It last) { seed(first, last); }
...
#define BOOST_RANDOM_MERSENNE_TWISTER_DISCARD_THRESHOLD 10000000
         ...
         */
        friend bool operator!=(const mersenne_twister_engine& x_,
            const mersenne_twister_engine& y_) { return !(x_ == y_); }
...
#undef BOOST_RANDOM_MT_DEFINE_CONSTANT
    ...
    class mersenne_twister : public mersenne_twister_engine<UIntType,

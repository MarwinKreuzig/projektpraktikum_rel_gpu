...
namespace random {
    namespace detail {
        ...
        inline T pow2(int n) {
            ...
            return (int_type(1) << (n % max_bits)) * const_pow<std::numeric_limits<T>::digits / max_bits>(multiplier, n / max_bits);
        }
        ...
        void generate_from_int(Engine& eng, Iter begin, Iter end) {
            ...
            int bits = (range == (std::numeric_limits<unsigned_type>::max)()) ? std::numeric_limits<unsigned_type>::digits : detail::integer_log2(range + 1);

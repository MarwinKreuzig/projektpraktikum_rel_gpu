    ...
    namespace detail {
        ...
        public:
            ...
            typedef typename boost::uint_t<
                (std::numeric_limits<boost::uintmax_t>::digits < std::numeric_limits<base_result>::digits) ? std::numeric_limits<boost::uintmax_t>::digits : std::numeric_limits<base_result>::digits>::fast result_type;

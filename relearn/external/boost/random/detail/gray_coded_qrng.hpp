...
namespace random {
    ...
    namespace qrng_detail {
        ...
        class gray_coded_qrng
            : public qrng_base<
                  gray_coded_qrng<LatticeT>, LatticeT, typename LatticeT::value_type> {
        public:
        ...
        private:
            ...
            typedef typename conditional<
                ((LatticeT::bit_count) < std::numeric_limits<size_type>::digits), check_bit_range, check_nothing>::type check_bit_range_t;
        ...
        public:
            ...
            //!
            //! Throws: nothing.
            static BOOST_CONSTEXPR result_type max BOOST_PREVENT_MACRO_SUBSTITUTION() { return low_bits_mask_t<LatticeT::bit_count>::sig_bits; }

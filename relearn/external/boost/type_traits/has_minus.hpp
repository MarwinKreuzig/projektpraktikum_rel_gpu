...
struct has_minus : public boost::binary_op_detail::has_minus_void_ptr_filter<
                       T, U, Ret,
...
#define BOOST_TT_FORBIDDEN_IF                                                                                                                                                   \
    (/* Lhs==pointer and Rhs==fundamental and Rhs!=integral */                                                                                                                  \
        (                                                                                                                                                                       \
            ::boost::is_pointer<Lhs_noref>::value && ::boost::is_fundamental<Rhs_nocv>::value && (!::boost::is_integral<Rhs_noref>::value))                                     \
        || /* Lhs==void* and (Rhs==fundamental or Rhs==pointer) */                                                                                                              \
        (                                                                                                                                                                       \
            ::boost::is_pointer<Lhs_noref>::value && ::boost::is_void<Lhs_noptr>::value && (::boost::is_fundamental<Rhs_nocv>::value || ::boost::is_pointer<Rhs_noref>::value)) \
        || /* Rhs==void* and (Lhs==fundamental or Lhs==pointer) */                                                                                                              \
        (                                                                                                                                                                       \
            ::boost::is_pointer<Rhs_noref>::value && ::boost::is_void<Rhs_noptr>::value && (::boost::is_fundamental<Lhs_nocv>::value || ::boost::is_pointer<Lhs_noref>::value)) \
        || /* Lhs=fundamental and Rhs=pointer */                                                                                                                                \
        (                                                                                                                                                                       \
            ::boost::is_fundamental<Lhs_nocv>::value && ::boost::is_pointer<Rhs_noref>::value)                                                                                  \
        || /* two different pointers */                                                                                                                                         \
        (                                                                                                                                                                       \
            ::boost::is_pointer<Lhs_noref>::value && ::boost::is_pointer<Rhs_noref>::value && (!::boost::is_same<Lhs_nocv, Rhs_nocv>::value)))

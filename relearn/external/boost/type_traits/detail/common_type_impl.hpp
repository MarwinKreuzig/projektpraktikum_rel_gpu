...
namespace type_traits_detail {
    ...
    template <class T, class U>
    struct common_type_class : public boost::conditional<
    ...
    template <class T, class U>
    struct common_type_impl : public boost::conditional<
                                  ct_class<T, U>::value,
    ...
    template <class T, class U>
    struct common_type_impl3 : public boost::conditional<
    ...
    template <class T, class U>
    struct common_type_impl4 : public boost::conditional<

...
namespace detail {
    ...
    struct is_copy_constructible_impl2 {
        ...
        //          ...
        //      };
        BOOST_STATIC_CONSTANT(bool, value = (sizeof(test(boost::declval<BOOST_DEDUCED_TYPENAME boost::add_reference<T const>::type>())) == sizeof(boost::type_traits::yes_type) && !boost::is_rvalue_reference<T>::value && !boost::is_array<T>::value));
    };
    ...
    struct is_copy_constructible_impl {
        ...
        BOOST_STATIC_CONSTANT(bool, value = (boost::detail::is_copy_constructible_impl2<boost::is_noncopyable<T>::value, T>::value));
    };

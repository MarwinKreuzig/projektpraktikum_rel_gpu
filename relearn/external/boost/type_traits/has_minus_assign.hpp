...
struct has_minus_assign : public boost::binary_op_detail::has_minus_assign_void_ptr_filter<
                              T, U, Ret,
...
#define BOOST_TT_FORBIDDEN_IF                                                                                                               \
    (/* Lhs==pointer and Rhs==fundamental and Rhs!=integral */                                                                              \
        ...
        (                                                                                                                                   \
            ::boost::is_pointer<Lhs_noref>::value && ::boost::is_void<Lhs_noptr>::value && ::boost::is_fundamental<Rhs_nocv>::value)        \
        || /* Rhs==void* and Lhs==fundamental */                                                                                            \
        (                                                                                                                                   \
            ::boost::is_pointer<Rhs_noref>::value && ::boost::is_void<Rhs_noptr>::value && ::boost::is_fundamental<Lhs_nocv>::value)        \
        ...
        (                                                                                                                                   \
            ...
            && (::boost::is_fundamental<Rhs_nocv>::value || ::boost::is_pointer<Rhs_noref>::value) && ::boost::is_const<Lhs_noref>::value))

...
// https://connect.microsoft.com/VisualStudio/feedback/details/800328/std-is-copy-constructible-is-broken
    ...
    struct is_copy_assignable_impl {
        ...
        BOOST_STATIC_CONSTANT(bool, value = (boost::detail::is_copy_assignable_impl2 < boost::is_noncopyable<T>::value || boost::is_const<unreferenced_t>::value || boost::is_array<unreferenced_t>::value, T > ::value));
#else
        BOOST_STATIC_CONSTANT(bool, value = (boost::detail::is_copy_assignable_impl2<boost::is_noncopyable<T>::value, T>::value));
#endif
    };

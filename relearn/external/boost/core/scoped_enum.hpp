...
inline BOOST_CONSTEXPR UnderlyingType underlying_cast(EnumType v) BOOST_NOEXCEPT {
 ...
 */
template <typename EnumType>
inline BOOST_CONSTEXPR typename EnumType::enum_type native_value(EnumType e) BOOST_NOEXCEPT {
...
template <typename EnumType>
inline BOOST_CONSTEXPR EnumType native_value(EnumType e) BOOST_NOEXCEPT {
    return e;
}

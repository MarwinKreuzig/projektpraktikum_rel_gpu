...
namespace core {
    namespace detail {
        ...
        template <class T>
        std::string sequence_template_name() {
            return detail::class_template_name<T>();
        }

        template <class T>
        std::string set_template_name() {
            return detail::class_template_name<T>();
        }
        ...
        template <class T>
        std::string array_template_name() {
            return detail::class_template_name<T>();
        }
...
#pragma warning(pop)
        ...
        template <>
        struct tn_holder<boost::int128_type> {
            static std::string type_name(std::string const& suffix) {
        ...
        template <>
        struct tn_holder<boost::uint128_type> {
            static std::string type_name(std::string const& suffix) {
        ...
        template <class T>
        int tn_add_each_impl(std::string& st) {
            if (!st.empty())
                st += ", ";
        ...
        std::string function_type_name(tn_identity<R(A...)>, std::string const& trailer, std::string const& suffix) {
        ...
        template <class T>
        std::pair<std::string, std::string> array_prefix_suffix(tn_identity<T>) {
            return std::pair<std::string, std::string>(tn_holder<T>::type_name(""), "");
        }

        template <class T, std::size_t N>
        std::pair<std::string, std::string> array_prefix_suffix(tn_identity<T[N]>) {
        ...
        template <class T>
        std::string array_type_name(tn_identity<T[]>, std::string const& suffix) {
            std::pair<std::string, std::string> r = detail::array_prefix_suffix(tn_identity<T>());
        ...
        template <class T, std::size_t N>
        std::string array_type_name(tn_identity<T[N]>, std::string const& suffix) {
        ...
        struct tn_holder<L<T, U, std::hash<T>, std::equal_to<T>, std::allocator<std::pair<T const, U>>>> {
            static std::string type_name(std::string const& suffix) {

...
namespace core {
    ...
    namespace detail {
        ...
        inline int countl_impl(boost::uint64_t x) BOOST_NOEXCEPT {
            ...
            return static_cast<boost::uint32_t>(x >> 32) != 0 ? boost::core::detail::countl_impl(static_cast<boost::uint32_t>(x >> 32)) : boost::core::detail::countl_impl(static_cast<boost::uint32_t>(x)) + 32;
    ...
    namespace detail {
        ...
        inline int countr_impl(boost::uint64_t x) BOOST_NOEXCEPT {
            ...
            return static_cast<boost::uint32_t>(x) != 0 ? boost::core::detail::countr_impl(static_cast<boost::uint32_t>(x)) : boost::core::detail::countr_impl(static_cast<boost::uint32_t>(x >> 32)) + 32;

...
#if (defined(__MAC_OS_X_VERSION_MIN_REQUIRED) && __MAC_OS_X_VERSION_MIN_REQUIRED >= 101200) || (defined(__IPHONE_OS_VERSION_MIN_REQUIRED) && __IPHONE_OS_VERSION_MIN_REQUIRED >= 100000)
...
#if !( \
    (defined(__MINGW32__) && (defined(__GNUC__) && (__GNUC__ * 100 + __GNUC_MINOR__) < 405)) || defined(__ibmxl__))
#include <cxxabi.h>
#include <cstring>
...
#if !defined(__FreeBSD__) && ((defined(__GNUC__) && (__GNUC__ * 100 + __GNUC_MINOR__) < 407) || defined(__OpenBSD__) || (defined(__QNXNTO__) && !defined(__GLIBCXX__) && !defined(__GLIBCPP__)) || defined(_LIBCPPABI_VERSION))

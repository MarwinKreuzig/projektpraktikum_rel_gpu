...
enum class TimerRegion : unsigned int {
    INITIALIZATION = 0,
    LOAD_SYNAPSES = 1,
    TRANSLATE_GLOBAL_IDS = 2,
    INITIALIZE_NETWORK_GRAPH = 3,

    SIMULATION_LOOP = 4,
    UPDATE_ELECTRICAL_ACTIVITY = 5,
    PREPARE_SENDING_SPIKES = 6,
    EXCHANGE_NEURON_IDS = 7,
    CALC_SERIAL_ACTIVITY = 8,
    CALC_SYNAPTIC_BACKGROUND = 9,
    ...
    COMMIT_NUM_SYNAPTIC_ELEMENTS = 15,
    FIND_SYNAPSES_TO_DELETE = 16,
    DELETE_SYNAPSES_ALL_TO_ALL = 17,
    PROCESS_DELETE_REQUESTS = 18,

    UPDATE_LEAF_NODES = 19,
    UPDATE_LOCAL_TREES = 20,
    EXCHANGE_BRANCH_NODES = 21,
    INSERT_BRANCH_NODES_INTO_GLOBAL_TREE = 22,
    UPDATE_GLOBAL_TREE = 23,

    FIND_TARGET_NEURONS = 24,
    CALC_TAYLOR_COEFFICIENTS = 25,
    CALC_HERMITE_COEFFICIENTS = 26,

    EMPTY_REMOTE_NODES_CACHE = 27,

    CREATE_SYNAPSES = 28,
    CREATE_SYNAPSES_EXCHANGE_REQUESTS = 29,
    CREATE_SYNAPSES_PROCESS_REQUESTS = 30,
    CREATE_SYNAPSES_EXCHANGE_RESPONSES = 31,
    CREATE_SYNAPSES_PROCESS_RESPONSES = 32,

    ADD_SYNAPSES_TO_NETWORKGRAPH = 33,
};

/**
 * This number is used as a shortcut to count the number of values valid for TimerRegion
 */
constexpr size_t NUMBER_TIMERS = 34;

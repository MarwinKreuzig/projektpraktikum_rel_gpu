...
public:
    ...
    */
     ...
     */
    [[nodiscard]] virtual bool is_neuron_local(size_t global_id) const = 0;
     ...
     */
    [[nodiscard]] virtual size_t get_local_id(size_t global_id) const = 0;
     ...
     */
    [[nodiscard]] virtual size_t get_global_id(size_t local_id) const = 0;
     ...
     */
    [[nodiscard]] virtual std::map<neuron_id, RankNeuronId> translate_global_ids(const std::vector<neuron_id>& global_ids) = 0;
     ...
     */
    [[nodiscard]] virtual neuron_id translate_rank_neuron_id(const RankNeuronId& rni) = 0;
     ...
     */
    [[nodiscard]] virtual std::map<RankNeuronId, neuron_id> translate_rank_neuron_ids(const std::vector<RankNeuronId>& ids) = 0;
};

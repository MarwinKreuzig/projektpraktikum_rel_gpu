...
IzhikevichModelGPU::IzhikevichModelGPU(const unsigned int h, std::unique_ptr<SynapticInputCalculator>&& synaptic_input_calculator,
    ...
    : NeuronModelGPU(create_poisson_model_data(), h, std::move(synaptic_input_calculator), std::move(background_activity_calculator), std::move(stimulus_calculator)), a {_a}, b{_b}, c{_c}, d{_d}, V_spike{_V_spike}, k1{_k1}, k2{_k2}, k3{_k3} {}

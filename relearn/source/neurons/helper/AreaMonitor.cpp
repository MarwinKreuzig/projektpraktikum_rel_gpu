...
AreaMonitor::AreaMonitor(Simulation * simulation, std::string area_name, unsigned int nr_neurons_in_area) : sim(simulation), area_name(std::move(area_name)), nr_neurons_in_area(nr_neurons_in_area) {
}
...
void AreaMonitor::write_data_to_file(std::string file_path) {

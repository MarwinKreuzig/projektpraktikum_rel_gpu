...
public:
     ...
     */
    LinearTransformation(double factor_change, double factor_start, double factor_cutoff) : factor(factor_change), factor_start(factor_start), factor_cutoff(factor_cutoff) {

...
template <typename AdditionalCellAttributes>
class BarnesHutLocationAwareBase {
public:
...
public:
    ...
    void set_acceptance_criterion(const double acceptance_criterion) {
        RelearnException::check(acceptance_criterion > 0.0, "BarnesHutLocationAware::set_acceptance_criterion: acceptance_criterion was less than or equal to 0 ({})", acceptance_criterion);
...
protected:
    ...
    [[nodiscard]] AcceptanceStatus test_acceptance_criterion(const position_type& source_position, const OctreeNode<AdditionalCellAttributes>* target_node,
        ...
        RelearnException::check(target_node != nullptr, "BarnesHutLocationAwareBase::test_acceptance_criterion: target_node was nullptr");
        ...
        RelearnException::check(target_position.has_value(), "BarnesHutLocationAwareBase::test_acceptance_criterion: target_position was bad");

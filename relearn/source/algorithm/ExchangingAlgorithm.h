...
public:
    ...
    [[nodiscard]] std::tuple<LocalSynapses, DistantInSynapses, DistantOutSynapses> Algorithm::update_connectivity(size_t number_neurons, const std::vector<UpdateStatus>& disable_flags,
        ...
        auto [responses_outgoing, synapses] = process_requests(number_neurons, synapse_creation_requests_incoming);
...
protected:
    ...
    process_requests(size_t number_neurons, const CommunicationMap<RequestType>& creation_requests) = 0;

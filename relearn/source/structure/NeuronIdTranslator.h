...
public:
     ...
     */
    void set_global_ids(size_t subdomain_idx, std::vector<NeuronID> global_ids) {
     ...
     */
    [[nodiscard]] NeuronID get_local_id(NeuronID global_id) const;
     ...
     */
    [[nodiscard]] NeuronID get_global_id(NeuronID local_id) const;

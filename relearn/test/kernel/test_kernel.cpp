...
nodes[i].
set_cell_neuron_id(NeuronIdAdapter::get_random_neuron_id(1000, 1000, mt)
);
nodes[i].
...
const auto distance = (position -
                       nodes[i].get_cell().get_position_for(element_type, signal_type).value()).calculate_2_norm();

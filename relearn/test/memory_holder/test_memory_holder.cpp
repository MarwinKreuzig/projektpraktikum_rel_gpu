...
ASSERT_EQ(dist, Constants::number_oct
+
child_idx *Constants::number_oct
+ i);
...
const std::vector<unsigned int> indices =
        ranges::views::iota(0U, Constants::number_oct) | ranges::to_vector | actions::shuffle(this->mt);
...
const std::vector<unsigned int> indices_child =
        ranges::views::iota(0U, Constants::number_oct) | ranges::to_vector | actions::shuffle(this->mt);
...
child->
set_child(ptr, child_child_index
);
}
}
}
...
if (
i *Constants::number_oct
+ Constants::number_oct > number_objects) {
...
offset++) {
if (offset >=
number_requesting_objects *Constants::number_oct
) {

...
const auto event_trace = Event::create_duration_begin_event("this-name-123", {}, 1236.05, 65, 135, {{"arg1", "val1"},
                                                                                                    {"arg3", "val3"}});
...
const auto event_trace = Event::create_counter_event("that-name-123", {}, 165, 12, 0, {{"arg1", "val1"},
                                                                                       {"arg3", "val3"}});
...
const auto event_trace = Event::create_counter_event("that-name-123", {EventCategory::async, EventCategory::calculation,
                                                                       EventCategory::mpi}, 165, 12, 0,
                                                     {{"arg1", "val1"},
                                                      {"arg3", "val3"}});

...
void CellTest::test_cell_dendrites_position() {
    ...
    ASSERT_NO_THROW(auto
    val = cell.get_position_for(ElementType::Dendrite, SignalType::Excitatory));
    ...
    ASSERT_NO_THROW(auto
    val = cell.get_position_for(ElementType::Dendrite, SignalType::Inhibitory));
...
void CellTest::test_cell_dendrites_position_exception() {
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_1_invalid_x_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_1_invalid_y_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_1_invalid_z_max),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_1_invalid_x_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_1_invalid_y_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_1_invalid_z_min),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_2_invalid_x_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_2_invalid_y_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_2_invalid_z_max),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_2_invalid_x_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_2_invalid_y_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Excitatory, pos_ex_2_invalid_z_min),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_1_invalid_x_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_1_invalid_y_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_1_invalid_z_max),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_1_invalid_x_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_1_invalid_y_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_1_invalid_z_min),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_2_invalid_x_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_2_invalid_y_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_2_invalid_z_max),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_2_invalid_x_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_2_invalid_y_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Dendrite, SignalType::Inhibitory, pos_in_2_invalid_z_min),
                 RelearnException);
...
void CellTest::test_cell_set_number_dendrites() {
    ...
    cell.set_number_excitatory_dendrites(
            static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_dends_ex_1));
    cell.set_number_inhibitory_dendrites(
            static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_dends_in_1));
    ...
    cell.set_number_excitatory_dendrites(
            static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_dends_ex_2));
    cell.set_number_inhibitory_dendrites(
            static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_dends_in_2));
    ...
    cell.set_number_dendrites_for(SignalType::Excitatory,
                                  static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_dends_ex_3));
    cell.set_number_dendrites_for(SignalType::Inhibitory,
                                  static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_dends_in_3));
    ...
    cell.set_number_elements_for(ElementType::Dendrite, SignalType::Excitatory,
                                 static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_dends_ex_4));
    cell.set_number_elements_for(ElementType::Dendrite, SignalType::Inhibitory,
                                 static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_dends_in_4));
...
void CellTest::test_cell_dendrites_position_combined() {
    ...
    ASSERT_THROW(auto
    tmp = cell.get_dendrites_position(), RelearnException);
...
void CellTest::test_cell_axons_position() {
    ...
    ASSERT_NO_THROW(auto
    val = cell.get_position_for(ElementType::Axon, SignalType::Excitatory));
    ...
    ASSERT_NO_THROW(auto
    val = cell.get_position_for(ElementType::Axon, SignalType::Inhibitory));
...
void CellTest::test_cell_axons_position_exception() {
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_1_invalid_x_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_1_invalid_y_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_1_invalid_z_max),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_1_invalid_x_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_1_invalid_y_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_1_invalid_z_min),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_2_invalid_x_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_2_invalid_y_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_2_invalid_z_max),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_2_invalid_x_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_2_invalid_y_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Excitatory, pos_ex_2_invalid_z_min),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_1_invalid_x_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_1_invalid_y_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_1_invalid_z_max),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_1_invalid_x_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_1_invalid_y_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_1_invalid_z_min),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_2_invalid_x_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_2_invalid_y_max),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_2_invalid_z_max),
                 RelearnException);
    ...
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_2_invalid_x_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_2_invalid_y_min),
                 RelearnException);
    ASSERT_THROW(cell.set_position_for(ElementType::Axon, SignalType::Inhibitory, pos_in_2_invalid_z_min),
                 RelearnException);
...
void CellTest::test_cell_set_number_axons() {
    ...
    cell.set_number_axons_for(SignalType::Excitatory,
                              static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_axs_ex_3));
    cell.set_number_axons_for(SignalType::Inhibitory,
                              static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_axs_in_3));
    ...
    cell.set_number_elements_for(ElementType::Axon, SignalType::Excitatory,
                                 static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_axs_ex_4));
    cell.set_number_elements_for(ElementType::Axon, SignalType::Inhibitory,
                                 static_cast<typename Cell<AdditionalCellAttributes>::counter_type>(num_axs_in_4));
...
void CellTest::test_cell_axons_position_combined() {
    ...
    ASSERT_THROW(auto
    tmp = cell.get_axons_position(), RelearnException);
...
void CellTest::test_cell_octants_exception() {
    ...
    ASSERT_THROW(auto
    tmp = cell.get_octant_for_position(pos_invalid_x_max), RelearnException);
    ASSERT_THROW(auto
    tmp = cell.get_octant_for_position(pos_invalid_y_max), RelearnException);
    ASSERT_THROW(auto
    tmp = cell.get_octant_for_position(pos_invalid_z_max), RelearnException);
    ASSERT_THROW(auto
    tmp = cell.get_octant_for_position(pos_invalid_x_min), RelearnException);
    ASSERT_THROW(auto
    tmp = cell.get_octant_for_position(pos_invalid_y_min), RelearnException);
    ASSERT_THROW(auto
    tmp = cell.get_octant_for_position(pos_invalid_z_min), RelearnException);
}

...
void CellTest::test_cell_dendrites_position() {
    ...
    ASSERT_NO_THROW(auto
                        val
        = cell.get_position_for(ElementType::Dendrite, SignalType::Excitatory));
    ...
    ASSERT_NO_THROW(auto
                        val
        = cell.get_position_for(ElementType::Dendrite, SignalType::Inhibitory));
...
void CellTest::test_cell_axons_position() {
    ...
    ASSERT_NO_THROW(auto
                        val
        = cell.get_position_for(ElementType::Axon, SignalType::Excitatory));
    ...
    ASSERT_NO_THROW(auto
                        val
        = cell.get_position_for(ElementType::Axon, SignalType::Inhibitory));
...
void CellTest::test_cell_octants_exception() {
    ...
    ASSERT_THROW(auto
                     tmp
        = cell.get_octant_for_position(pos_invalid_x_max),
        RelearnException);
    ASSERT_THROW(auto
                     tmp
        = cell.get_octant_for_position(pos_invalid_y_max),
        RelearnException);
    ASSERT_THROW(auto
                     tmp
        = cell.get_octant_for_position(pos_invalid_z_max),
        RelearnException);
    ASSERT_THROW(auto
                     tmp
        = cell.get_octant_for_position(pos_invalid_x_min),
        RelearnException);
    ASSERT_THROW(auto
                     tmp
        = cell.get_octant_for_position(pos_invalid_y_min),
        RelearnException);
    ASSERT_THROW(auto
                     tmp
        = cell.get_octant_for_position(pos_invalid_z_min),
        RelearnException);
}

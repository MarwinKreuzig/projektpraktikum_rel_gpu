...
TEST_F(BarnesHutBaseTest, testBarnesHutBaseACException) {
...
TEST_F(BarnesHutInvertedBaseTest, testBarnesHutBaseACLeafAxons) {
...
TEST_F(BarnesHutBaseTest, testBarnesHutBaseACLeafDendrites) {
    using additional_cell_attributes = BarnesHutCell;
...
TEST_F(BarnesHutBaseTest, testBarnesHutBaseACParentAxon) {
    using additional_cell_attributes = BarnesHutInvertedCell;
...
TEST_F(BarnesHutBaseTest, testBarnesHutBaseACParentDendrite) {
    using additional_cell_attributes = BarnesHutCell;
...
TEST_F(BarnesHutInvertedBaseTest, testBarnesHutBaseNodesToConsiderAxon) {
    using additional_cell_attributes = BarnesHutInvertedCell;
...
TEST_F(BarnesHutBaseTest, testBarnesHutBaseNodesToConsiderDendrite) {
    using additional_cell_attributes = BarnesHutCell;
...
TEST_F(BarnesHutBaseTest, testBarnesHutBaseNodesToConsiderNoAxons) {
    using additional_cell_attributes = BarnesHutCell;
...
TEST_F(BarnesHutInvertedBaseTest, testBarnesHutBaseNodesToConsiderNoAxons2) {
    using additional_cell_attributes = BarnesHutInvertedCell;
...
TEST_F(BarnesHutBaseTest, testBarnesHutBaseNodesToConsiderNoElements) {
    using additional_cell_attributes = BarnesHutCell;
...
TEST_F(BarnesHutInvertedBaseTest, testBarnesHutBaseNodesToConsiderNoElements2) {
    using additional_cell_attributes = BarnesHutInvertedCell;
...
TEST_F(BarnesHutBaseTest, testBarnesHutBaseNodesToConsiderNoDendrites) {
    using additional_cell_attributes = BarnesHutCell;
...
TEST_F(BarnesHutInvertedBaseTest, testBarnesHutBaseNodesToConsiderNoDendrites2) {
    using additional_cell_attributes = BarnesHutInvertedCell;
...
TEST_F(BarnesHutBaseTest, testBarnesHutBaseNodesToConsiderException) {
    using additional_cell_attributes = BarnesHutCell;

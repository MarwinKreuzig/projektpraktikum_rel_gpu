...
TEST_F(BarnesHutInvertedBaseTest, testFindTargetNeuronLocationAwareException) {
    ...
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neuron_location_aware(source, position, nullptr, ElementType::Axon, searched_signal_type, branching_level, Constants::bh_default_theta);, RelearnException);
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neuron_location_aware(source, position, &root, ElementType::Axon, searched_signal_type, branching_level, 0.0);, RelearnException);
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neuron_location_aware(source, position, &root, ElementType::Axon, searched_signal_type, branching_level, Constants::bh_max_theta + eps);, RelearnException);
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neuron_location_aware(source, position, &root, ElementType::Axon, searched_signal_type, branching_level, too_small_acceptance_criterion);, RelearnException);
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neuron_location_aware(source, position, &root, ElementType::Axon, searched_signal_type, branching_level, too_large_acceptance_criterion);, RelearnException);
}
...
TEST_F(BarnesHutInvertedBaseTest, testFindTargetNeuronLocationAwareFullChoice) {
    ...
    for (const auto neuron_id : NeuronID::range(number_neurons)) {
        ...
        const RankNeuronId searching_id{ MPIRank::root_rank(), neuron_id };
        auto found_target = BarnesHutBase<additional_cell_attributes>::find_target_neuron_location_aware(searching_id, position, &root, ElementType::Axon, searched_signal_type, branching_level, acceptance_criterion);
...
TEST_F(BarnesHutInvertedBaseTest, testFindTargetNeuronsLocationAwareException) {
    ...
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neurons_location_aware(source, position, 1, nullptr, ElementType::Axon, searched_signal_type, branching_level, Constants::bh_default_theta);, RelearnException);
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neurons_location_aware(source, position, 1, &root, ElementType::Axon, searched_signal_type, branching_level, 0.0);, RelearnException);
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neurons_location_aware(source, position, 1, &root, ElementType::Axon, searched_signal_type, branching_level, Constants::bh_max_theta + eps);, RelearnException);
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neurons_location_aware(source, position, 1, &root, ElementType::Axon, searched_signal_type, branching_level, too_small_acceptance_criterion);, RelearnException);
    ASSERT_THROW(auto val = BarnesHutBase<additional_cell_attributes>::find_target_neurons_location_aware(source, position, 1, &root, ElementType::Axon, searched_signal_type, branching_level, too_large_acceptance_criterion);, RelearnException);
}

TEST_F(BarnesHutInvertedBaseTest, testFindTargetNeuronsLocationAwareFuullChoice) {
    using additional_cell_attributes = BarnesHutInvertedCell;
    ...
    for (const auto neuron_id : NeuronID::range(number_neurons)) {
        ...
        const RankNeuronId searching_id{ MPIRank::root_rank(), neuron_id };
        auto found_targets = BarnesHutBase<additional_cell_attributes>::find_target_neurons_location_aware(searching_id, position, number_vacant_elements, &root, ElementType::Axon, searched_signal_type, branching_level, acceptance_criterion);
...
TEST_F(BarnesHutInvertedBaseTest, testFindTargetNeuronsLocationAwareFuullChoiceDistributed) {
    using additional_cell_attributes = BarnesHutInvertedCell;

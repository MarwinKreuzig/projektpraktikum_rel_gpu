...
TEST_F(NeuronIDTest, testNeuronIDUninitialized
) { // NOLINT
...
TEST_F(NeuronIDTest, testNeuronIDVirtual
) { // NOLINT
...
TEST_F(NeuronIDTest, testNeuronIDConstructorDefault
) { // NOLINT
NeuronID id{};
...
TEST_F(NeuronIDTest, testNeuronIDConstructorOnlyID
) { // NOLINT
...
get_neuron_id(), id_val

);
ASSERT_EQ(static_cast
<std::uint64_t>(id), id_val
);
}
...
TEST_F(NeuronIDTest, testNeuronIDComparisons1
) { // NOLINT
...
TEST_F(NeuronIDTest, testNeuronIDComparisons2
) { // NOLINT
constexpr static auto min = NeuronID::limits::min;
constexpr static auto max = NeuronID::limits::max;

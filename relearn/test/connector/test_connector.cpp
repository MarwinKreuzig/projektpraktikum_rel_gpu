...
TEST_F(ConnectorTest, testForwardConnectorIncoming) {
    ...
    for (
        ...
        ASSERT_LE(now_connected_excitatory_counts[neuron_id],
            static_cast<unsigned int>(now_grown_excitatory_counts[neuron_id]))
            << neuron_id;
        ASSERT_LE(now_connected_inhibitory_counts[neuron_id],
            static_cast<unsigned int>(now_grown_inhibitory_counts[neuron_id]))
            << neuron_id;

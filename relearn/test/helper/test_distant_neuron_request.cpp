...
TEST_F(DistantNeuronRequestTest, testConstructor) {
    ...
    DistantNeuronRequest dnr{ golden_source_neuron_id, golden_source_position, golden_target_id, golden_target_neuron_type,
        golden_signal_type };
...
TEST_F(DistantNeuronRequestTest, testConstructorException) {
    ...
    ASSERT_THROW(DistantNeuronRequest

                     dnr(NeuronID::virtual_id(), golden_source_position, golden_target_id, golden_target_neuron_type, golden_signal_type

                         ),
        RelearnException);
    ASSERT_THROW(DistantNeuronRequest

                     dnr(NeuronID::uninitialized_id(), golden_source_position, golden_target_id, golden_target_neuron_type, golden_signal_type

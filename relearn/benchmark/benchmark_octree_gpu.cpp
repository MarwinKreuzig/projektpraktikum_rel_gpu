...
//    auto neurons_to_place = NeuronsAdapter::generate_random_neurons(Vec3d{ 0.0, 0.0, 0.0 }, Vec3d{ 100.0, 100.0, 100.0 }, 100, 100, mt);
//    OctreeImplementation<BarnesHutCell> octree(Vec3d{ 0.0, 0.0, 0.0 }, Vec3d{ 100.0, 100.0, 100.0 }, 1);
//
//    for (const auto& [position, id] : neurons_to_place) {
//        octree.insert(position, id);
//    }
